...
def banner(owner):
    os.system('clear')
    # Menggunakan font slant agar terlihat keren
...
def chat_engine(pesan, history, api_key, model, system):
    ...
    try:
        ...
        return "Gagal konek! Cek API Key lo atau koneksi internet."
...
def main():
    ...
    while True:
        ...
        if user_input.lower() in ['exit', 'quit']:
            print(Fore.RED + "Exiting Oxylus-AI...")
            break
        
        print(Fore.YELLOW + "Wait, Oxylus is thinking...")
